...
const About = () => {
  ...
  return (
    <div  className='w-full h-screen '>
         ...
         <p className='text-xl mt-5  tablet:text-center  tablet:text-xl laptop:text-center transition-all animate-pulse duration-75 '>I am a passionate full-Stack Developer,
